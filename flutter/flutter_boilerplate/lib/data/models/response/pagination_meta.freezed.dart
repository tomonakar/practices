...
class _$PaginationMetaImpl implements _PaginationMeta {
  ...
  @override
  String toString() {
    return 'PaginationMeta(currentPage: $currentPage, lastPage: $lastPage, perPage: $perPage, total: $total, hasMore: $hasMore)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, currentPage, lastPage, perPage, total, hasMore);
